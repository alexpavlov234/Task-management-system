...
namespace Task_management_system.Areas.Identity.Pages.Account
{
    public class ResetPasswordModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Display(Name = "Парола")]
            [StringLength(100, ErrorMessage = "Дължината на {0} трябва да бъде най-малко {2} и най-много {1} символа.", MinimumLength = 6)]
        ...
        public IActionResult OnGet(string code = null)
        {
            if (code == null)
            {
                return BadRequest("За промяна на паролата трябва да се предостави код.");
            }
            else
            {
