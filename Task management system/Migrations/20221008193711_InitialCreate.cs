        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreateProjectPermission = table.Column<bool>(type: "bit", nullable: false),
                    EditProjectPermission = table.Column<bool>(type: "bit", nullable: false),
                    ManageMembersPermission = table.Column<bool>(type: "bit", nullable: false),
                    CreateTaskPermission = table.Column<bool>(type: "bit", nullable: false),
                    EditTaskPermission = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Role",
                columns: new[] { "RoleId", "CreateProjectPermission", "CreateTaskPermission", "EditProjectPermission", "EditTaskPermission", "ManageMembersPermission", "RoleName" },
                values: new object[] { 1, true, true, true, true, true, "Администратор" });
